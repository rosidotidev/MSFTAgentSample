...
from afw_core.workflows.doc_ingest import build_doc_ingest_workflow
...
async def main():
    ...
    workflow = build_doc_ingest_workflow(client, options, OUTPUT_DIR)

    print("🚀 Doc-ingest workflow pipeline is online...")
    ...
    async for event in workflow.run(
        ...
        if event.type == "executor_invoked":
            label = {
                ...
                "image_analyst": "🔍 Analysing images",
                "content_assembler": "📝 Assembling Markdown documents",
    ...
    print("\n🏁 Doc-ingest workflow pipeline completed.")
