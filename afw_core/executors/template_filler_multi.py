...
Multi-doc variant: processes each document independently from the JSON
produced by ChunkedTemplateAssemblerExecutor.  Pure Python — no LLM.
"""
...
class TemplateFillerMultiExecutor(Executor):

    def __init__(self):
        super().__init__(id="template_filler_multi")
