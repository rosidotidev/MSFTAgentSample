...
from afw_core.workflows.doc_ingest_tpl_multi import build_doc_ingest_tpl_multi_workflow
...
async def main():
    ...
    workflow = build_doc_ingest_tpl_multi_workflow(client, options, OUTPUT_DIR)

    print("🚀 Doc-ingest scaled workflow is online...")
    ...
    async for event in workflow.run(
        ...
        if event.type == "executor_invoked":
            label = {
                ...
                "chunked_template_assembler": "📝 Assembling Markdown (chunked)",
    ...
    print("\n🏁 Doc-ingest scaled workflow completed.")
